...
import type { LLMService, LLMResponse, ConversationTurn } from './types';
...
4. Termine par une question ouverte pour engager le dialogue : "Qu'est-ce qui te fait dire cela ?", "As-tu deja vecu une situation similaire ?"
